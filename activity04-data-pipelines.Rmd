...
We need the major itself, the number of people who graduated with that major, and how many of those people who graduated are now employed. Using excel you can just divide the number employed by the number who graduated to get the rate and then use a min function to find the minimum. In SAS you can use proc means with min on the emplyment rate to find the minimum employment rate. 
...
Mathematics And Computer Science, Military Technologies, Botany, Soil Science, Educational Administration And Supervision all have zero unemplyoment out of college.
...
Child education and other social work appeasr to have the highest amount of female participation overall.
...
Most of the majors that are below the median wage in STEM fields are relatively close to the median with the exception of zoology which is almost 10000 dollars below the median. 
